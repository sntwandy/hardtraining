...
export default function UserPage() {
  ...
  const getClients = async () => {
    const { data, error } = await supabase
      .from('clients')
      .select('*')
      .eq('location', 'La Loteria'); // Filter by location
    ...
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="subtitle2" mb={4}>
          Clientes: <Typography variant="h5">La Loteria</Typography>
        </Typography>
        ...
        >
          <Box sx={style}>
            <Typography id="modal-modal-title" variant="h6" component="h2" mb={3}>
              Formulario de Registro de Cliente en sucursal: La Loteria
            </Typography>
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth variant="outlined" required>
                    ...
                    <Select
                      ...
                      label="Sucursal"
                    >
                      <MenuItem value="La Loteria">La Loteria</MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
                <Grid item xs={12}>
